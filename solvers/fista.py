...
class Solver(BaseSolver):
    ...
    def set_objective(self, kspace_data, fourier_op, image, wavelet_name="sym8", nb_scale=4, lambd=2 * 1e-7):
    ...
    def run(self, n_iter):
        linear_op = WaveletN(wavelet_name=self.wavelet_name, nb_scale=self.nb_scale)
